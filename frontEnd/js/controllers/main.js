...
//=================================================
    .controller('smsViewCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService){
        ...
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
// Admin Campaigns
//=================================================
    .controller('adminCampaignsCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', '$rootScope', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService, $rootScope){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
// Admin Users
//=================================================
    .controller('adminUsersCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', '$rootScope', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService, $rootScope){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
// Admin Orgs
//=================================================
    .controller('adminOrgsCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', '$rootScope', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService, $rootScope){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
// Admin Leads
//=================================================
    .controller('adminLeadsCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
// Supervisor Monitor
//=================================================
    .controller('supervisorMonitorCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', '$rootScope', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService, $rootScope){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
//=================================================
    .controller('supervisorRecordingsCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', '$rootScope', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService, $rootScope){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
...
// Supervisor Reports
//=================================================
    .controller('supervisorReportsCtrl', ['$scope', 'getStateBreadcrumbs', '$window', '$filter', '$sce', 'ngTableParams', 'tableService', '$rootScope', function($scope, getStateBreadcrumbs, $window, $filter, $sce, ngTableParams, tableService, $rootScope){
        $scope.states = getStateBreadcrumbs.get();
        $scope.handleBreadcrumbs = function(){
            $scope.states = getStateBreadcrumbs.get();
        }
